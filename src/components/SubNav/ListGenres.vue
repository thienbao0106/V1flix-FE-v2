...
export default {
  props: ["listGenres", "toggleGenresMenu", "toggleSubNav", "isGenresList"],
  methods: {
    capitalizeWord,
  },
  components: {},
...
<template>
  <div
    ...
    class="absolute lg:left-[14rem] left-[11rem] overflow-auto top-[11rem] h-[500px] bottom-0 lg:w-[50rem] w-[14rem]"
  >
    <div
