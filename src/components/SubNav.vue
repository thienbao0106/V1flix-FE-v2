...
<template>
  ...
  >
    ...
    ></div>
    <div id="menu" class="h-full w-[14rem] bg-mainColor z-20 relative">
      <div class="sticky top-0 pt-5">
        ...
        <ul class="list-none text-center space-y-4 pt-4 font-bold">
          <li class="hover:text-secondColorBrighter cursor-pointer">Genres</li>
          <li>
            <router-link
              to="/latest"
              class="hover:text-secondColorBrighter cursor-pointer decoration-none text-white"
